...
import { AtSign, Copy, Edit, Key, Lock, LogOut, Mail, MoreHorizontal, Shield, UserIcon, UserCog } from "lucide-react"
...
export default function UserDetailView({ user = userExample }: { user?: UserDetail }) {
  ...
  return (
    <Card className="w-full max-w-3xl mx-auto overflow-hidden">
      <CardHeader>
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          ...
          <div className="space-y-1">
            <CardTitle className="text-xl sm:text-2xl">{user.profile.fullName}</CardTitle>
            ...
            <div className="md:hidden flex justify-between items-center border-b pb-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem onClick={() => setActiveTab("profile")}>Perfil</DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setActiveTab("security")}>Seguridad</DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <div className="flex items-center justify-between rounded-md border p-2">
                    <code className="text-sm truncate">{user.id}</code>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2 rounded-md border p-2">
                    ...
                    <span className="truncate">{user.profile.fullName}</span>
                  </div>
                </div>
              </div>
          ...
          <TabsContent value="security" className="mt-4 space-y-6">
            <div className="grid gap-4">
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between p-2 rounded-md border gap-2">
                  ...
                  <Badge variant="outline" className="bg-red-100 text-red-800 border-red-200 self-start sm:self-auto">
                    Desactivado
                  </Badge>
                </div>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between p-2 rounded-md border gap-2">
                  ...
                  <Badge
                    variant="outline"
                    className="bg-green-100 text-green-800 border-green-200 self-start sm:self-auto"
                  >
                    Verificado
                  </Badge>
                </div>
      ...
      <CardFooter className="flex flex-col sm:flex-row justify-between border-t pt-6 gap-3">
        <Button variant="outline" className="gap-2 text-red-600 hover:text-red-700 hover:bg-red-50 w-full sm:w-auto">
